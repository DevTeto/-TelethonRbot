...
async def mute(c, msg):
    ...
    try:
        ...
        if msg.reply_to_message.from_user.id == 6352598131:
            return await msg.edit("↢ لا يمكنك كتم تيتو")
...
async def un_mute(c, msg):
    ...
    try:
        ...
        if msg.reply_to_message.from_user.id == 6352598131:
            return await msg.edit("↢ لا يمكنك الغاء كتم تيتو")
...
async def bann(c, msg):
    ...
    if msg.reply_to_message.from_user.id == 6352598131:
        return await msg.edit("↢ لا يمكنك حظر تيتو")
    try:
...
async def un_ban(c, msg):
    ...
    if msg.reply_to_message.from_user.id == 6352598131:
        return await msg.edit("↢ لا يمكنك الغاء حظر تيتو")
    try:
