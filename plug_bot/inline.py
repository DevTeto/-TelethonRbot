...
async def answer(client, inline_query):
    reply_markup = InlineKeyboardMarkup(
            [[
             ...
             [
             InlineKeyboardButton("✅ - قناه السورس - ✅",url="https://t.me/wx_pm"),
             ],
             [
             InlineKeyboardButton("🔺️ - لتنصيب حسابك - 🔻",url="https://t.me/topteto"),
             ]]
             )
    await inline_query.answer(
        results=[
            InlineQueryResultArticle(
                ...
                url="https://t.me/topteto",
                description="Ahmed Teto 🖤",
